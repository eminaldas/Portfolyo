...
function Navbar() {
  return (
    <nav className="fixed  w-full top-0 z-50 animation-navbar">
      <div className="bg-white/50 dark:bg-[var(--color-800)] backdrop-blur-sm w-full mx-auto px-4 sm:px-6 lg:px-8  border-b-2 border-[var(--color-50)] dark:border-[var(--color-800)]">
