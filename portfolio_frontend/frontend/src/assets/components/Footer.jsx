...
const Footer = () => {
  ...
  return (
    <footer className="w-full border-t border-outline-variant/20 flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto bg-background py-12 px-8 font-body text-sm tracking-wide">
      <div className="text-lg font-black text-on-background mb-6 md:mb-0 font-headline">Emin Aldaş</div>
