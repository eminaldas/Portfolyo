...
const Footer = () => {
  ...
  return (
    <footer className="w-full border-t border-outline-variant/20 flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto bg-background py-14 px-8 font-body text-sm tracking-wide">
      <div className="text-lg font-black text-on-background mb-6 md:mb-0 font-headline leading-loose pb-2">Muhammed Emin Aldaş</div>
      <div className="text-on-surface-variant mb-6 md:mb-0">© 2026 Muhammed Emin Aldaş. {t.footer.madeWith}</div>
